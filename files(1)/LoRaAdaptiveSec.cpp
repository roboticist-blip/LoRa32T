#include "LoRaAdaptiveSec.h"
#include <esp_system.h>   // esp_random(), esp_efuse_mac_get_default()
#include <string.h>

// ─── Constexpr storage (required pre-C++17) ──────────────────────────────────
constexpr float LoRaAdaptiveSec::_toaNorm[3];

// ═══════════════════════════════════════════════════════════════════════════
// Construction
// ═══════════════════════════════════════════════════════════════════════════
LoRaAdaptiveSec::LoRaAdaptiveSec()
...
void LoRaAdaptiveSec::begin(const uint8_t key[16],
                             CostWeights weights,
...
// ═══════════════════════════════════════════════════════════════════════════
void LoRaAdaptiveSec::updateLinkMetrics(const ACKMetrics& ack)
{
...
void LoRaAdaptiveSec::updateLinkState(float snrDb, float perRadio,
...
// Cost function
// ═══════════════════════════════════════════════════════════════════════════
float LoRaAdaptiveSec::_retryFactor(float per) const
{
    float p = (per > 0.95f) ? 0.95f : per;
    return 1.0f / (1.0f - p);
}

float LoRaAdaptiveSec::_gammaEffective() const
{
    return _w.gamma0 + _w.kappa * (1.0f - _ls.battLevel);
}

float LoRaAdaptiveSec::_computeCost(AESMode m, SecurityPolicy policy) const
{
...
// ═══════════════════════════════════════════════════════════════════════════
AESMode LoRaAdaptiveSec::selectMode(SecurityPolicy policy)
{
    _ls.policy = policy;
...
// Nonce construction
// ═══════════════════════════════════════════════════════════════════════════
void LoRaAdaptiveSec::_buildNonce(uint32_t seqNum, uint8_t nonce[12]) const
{
...
// Encrypt
// ═══════════════════════════════════════════════════════════════════════════
bool LoRaAdaptiveSec::encrypt(const uint8_t* plain, size_t plainLen,
...
// Decrypt
// ═══════════════════════════════════════════════════════════════════════════
bool LoRaAdaptiveSec::decrypt(const CryptoFrame& frame, uint8_t* plain)
{
...
// ═══════════════════════════════════════════════════════════════════════════
ACKMetrics LoRaAdaptiveSec::buildACK(int8_t rawSnr,
...
// ═══════════════════════════════════════════════════════════════════════════
bool LoRaAdaptiveSec::_encryptCBC(const uint8_t* plain, size_t len,
...
bool LoRaAdaptiveSec::_decryptCBC(const uint8_t* cipher, size_t len,
...
// ═══════════════════════════════════════════════════════════════════════════
bool LoRaAdaptiveSec::_encryptCTR(const uint8_t* plain, size_t len,
...
bool LoRaAdaptiveSec::_decryptCTR(const uint8_t* cipher, size_t len,
...
// ═══════════════════════════════════════════════════════════════════════════
bool LoRaAdaptiveSec::_encryptGCM(const uint8_t* plain, size_t len,
                                   const uint8_t* nonce,
...
bool LoRaAdaptiveSec::_decryptGCM(const uint8_t* cipher, size_t len,
                                   const uint8_t* nonce,
                                   const uint8_t* aad,  size_t aadLen,
